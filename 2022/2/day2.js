...
function part2Solution(data) {
  data = data.replaceAll(/(A)/gim, 'R');
  data = data.replaceAll(/(B)/gim, 'P');
  data = data.replaceAll(/(C)/gim, 'S');
...
function part1Solution(data) {
  data = data.replaceAll(/(A|X)/gim, 'R');
  data = data.replaceAll(/(B|Y)/gim, 'P');
  data = data.replaceAll(/(C|Z)/gim, 'S');
